...
`575 Tests` `3-Layer Isolation` `19 Domain Rules` — [상세 보기 ↗](https://chanminkim-k.github.io/chanminkim-K/docs/portfolio-chanmin-kim.pdf#page=3)
...
`응답시간 81%↓` `실패율 92%↓` `처리량 4.6×` — [상세 보기 ↗](https://chanminkim-k.github.io/chanminkim-K/docs/portfolio-chanmin-kim.pdf#page=10) · [Repository ↗](https://github.com/chanminkim-K/ERPSystem)
...
| `2021.03 – 2025.02` | **동의대학교 응용소프트웨어공학과** | 졸업 |
